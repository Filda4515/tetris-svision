...
export class HallOfFameEntity extends AbstractEntity {
  ...
  init() {
    ...
    this.addEntity(
      new TextEntity(this, this.app.fonts.fonts5x5, 0, 0, this.width, 9, 'HALL OF FAME', ZXColor.brightWhite, false, {
        align: 'center',
        topMargin: 2,
      }),
    );
    ...
    this.addEntity(
      new ButtonEntity(
        ...
        'CLOSE',
        { id: 'closeHallOfFame' },
        ['Enter', 'Escape', ' ', 'GamepadOK', 'GamepadExit'],
        ZXColor.brightWhite,
        ZXColor.brightBlue,
