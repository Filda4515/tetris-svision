...
window.addEventListener('touchstart', (event) => gameApp.inputEventsManager.eventTouchStart(event), { passive: false });
window.addEventListener('touchend', (event) => gameApp.inputEventsManager.eventTouchEnd(event), { passive: false });
window.addEventListener('touchcancel', (event) => gameApp.inputEventsManager.eventTouchEnd(event), { passive: false });
window.addEventListener('touchmove', (event) => gameApp.inputEventsManager.eventTouchMove(event), { passive: false });
